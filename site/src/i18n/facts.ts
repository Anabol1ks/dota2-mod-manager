    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '<b>Who else links here is written down.</b> The catalog\'s README and install guide, a YouTube walkthrough and the projects built from this code are in <a href="https://github.com/TheFleece/dota2-mod-manager/blob/main/MENTIONS.md">MENTIONS.md</a>, with dates. The pages the maintainer wrote are listed separately.',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '<b>Кто ещё на нас ссылается, записано.</b> README каталога и его гайд по установке, разбор на YouTube и проекты, выросшие из этого кода, собраны с датами в <a href="https://github.com/TheFleece/dota2-mod-manager/blob/main/MENTIONS.md">MENTIONS.md</a>. Страницы, которые написал сам автор, идут отдельным списком.',
